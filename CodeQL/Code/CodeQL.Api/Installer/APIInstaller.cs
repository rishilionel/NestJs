...
using ElmahCore.Mvc;
using ElmahCore;
using CodeQL.Api.Filters;
using CodeQL.Business.Installer;

namespace CodeQL.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "CodeQL API", Version = version + "-" + branch});
            });
